...
NOMAD parser for Meysam's graphene simulations
...
```sh
git clone https://github.com/fabianli789/graphene_parser.git
cd graphene_parser
...
```sh
pip install dist/graphene_parser-0.1.0
```
